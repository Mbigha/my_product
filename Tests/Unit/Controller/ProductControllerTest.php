<?php
namespace Mbigha\MyProduct\Tests\Unit\Controller;
...
{
    /**
     * @var \Mbigha\MyProduct\Controller\ProductController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Mbigha\MyProduct\Controller\ProductController::class)
    ...
    public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView()
    {
        ...
        $productRepository = $this->getMockBuilder(\Mbigha\MyProduct\Domain\Repository\ProductRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $product = new \Mbigha\MyProduct\Domain\Model\Product();
